<%-- 
    Document   : OrdenGUI
    Created on : May 24, 2021, 12:50:05 AM
    Author     : jesus
--%>
                    ...
                    <table class="tabla-lista subtabla">
                        ...
                        <form action="OrdenControl" method="post">
                            <tr>
                                ...
                                <th class="tabla-titulo tabla-border">Código</th><td class="tabla-border"><input class="input-buscar" type="text" name="codProv" value="<%= fila3[0] %>" required></td>
                                <td class="buscar"><input type="hidden" name="acceso" value="Buscar"><button type="submit" name="acceso" class="btn-buscarProv"><i class="fas fa-search"></i></button></td>
                            </tr>
                            <tr>
                    ...
                    <table class="tabla-lista subtabla">
                        <tr>
                            <form action="OrdenControl" method="post">
                                ...
                                <th><input type="hidden" name="codProv" value="<%= fila3[0] %>"></th>
                                <th class="tabla-titulo"><input type="submit" name="acceso" class="btn-nuevo" value="Nueva Orden"></th>
                                <th class="tabla-titulo"><input type="submit" name="acceso" class="btn-listar" value="Listar Articulos"></th>
                                <th class="tabla-titulo"><input type="submit" name="acceso" class="btn-guardar" value="Grabar Orden"></th>
                            </form>
                        </tr>
                    </table>
                </div>
