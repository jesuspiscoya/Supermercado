...
<html>
    ...
    <body>
        <p class="titulo-prin">Editar Cliente</p>
        <% Object[] fila=(Object[])session.getAttribute("fila"); %>
        <div class="center">
            <form class="formEditar" action="ClienteControl" method="post">
                ...
                <div class="botones">
                    ...
                    <input type="button" name="back" class="btn-back" value="Regresar" onclick="location.href='ClienteBuscar.jsp'">
                </div>
            </form>
        </div>
    </body>
